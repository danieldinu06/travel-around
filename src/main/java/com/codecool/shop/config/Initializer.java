...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        String productsFilePath = "src/main/resources/data/categories.json";
        String suppliersFilePath = "src/main/resources/data/categories.json";
        ...
        try {
            SupplierDaoMem.setInstance(new Gson().fromJson(new FileReader(suppliersFilePath), SupplierDaoMem.class));
        } catch(FileNotFoundException e) {
            e.printStackTrace();
        }
