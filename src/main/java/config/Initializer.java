...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        Restaurant cafeAthenee = new Restaurant("Cafe Athenee", "Delightful pastries, sandwiches, coffee and drinks , excellent service, good place to watch people and be seen during the Enescu Classical Music Festival.", (float)4.5, romanianAthenaeum);
